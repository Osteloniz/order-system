...
import { ClipboardList, Package, Tags, Settings, LogOut, Store, Menu, X, BadgePercent, ChefHat, ShoppingCart } from 'lucide-react'
...
const menuItems = [
  ...
  { href: '/admin/novo-pedido', label: 'Novo Pedido', icon: ShoppingCart },
