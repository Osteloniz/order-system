...
- Para o Pix direto do Mercado Pago, a confirmacao publica, a listagem admin e o KDS agora tambem fazem reconciliacao ativa e segura de cobrancas pendentes, para que um pagamento aprovado consiga refletir no pedido mesmo se o webhook atrasar ou falhar temporariamente
...
- A regra de reserva de estoque para pedidos comuns ficou mais rigida: qualquer pedido comum passa a reservar estoque assim que a loja o tira de `FEITO` no fluxo operacional, independentemente do metodo de pagamento; a baixa definitiva continua acontecendo apenas em `ENTREGUE`
